...
export class TokenDefinitionService {
  private readonly _definedTokens: Array<TokenDefinition> = [
    ...
    new TokenDefinition(Token.TABOO, 'TABOO', 'TABOO Token', '0x9abdba20edfba06b782126b4d8d72a5853918fd0'),
    new TokenDefinition(Token.GHC, 'GHC', 'Galaxy Heroes Coin', '0x683fae4411249Ca05243dfb919c20920f3f5bfE0'),
    new TokenDefinition(Token.BABYDOGEZILLA, 'BABYDOGEZILLA', 'BABYDOGEZILLA', '0x0fbc08905c1d683cf7530bb2a70bb0bde231e5b9'),
    new TokenDefinition(Token.SHIBAZILLA, 'SHIBAZILLA', 'ShibaZilla', '0x68810a6f5bb0491cb9ccf8c52735a1acf5f28009'),
